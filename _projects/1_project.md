...
img: assets/img/project_1/g1_mpm.gif
importance: 1
category: work
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="https://drive.google.com/file/d/1Q80-xBo2MURN0YwOGbuw151gN_4z0xzH/preview" class="img-fluid rounded z-depth-1" controls=true autoplay=true width=992 height=1080 %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="https://drive.google.com/file/d/1hkxRZM_mv2P_YO0HoTb8wdCi5di_FpTS/preview" class="img-fluid rounded z-depth-1" controls=true autoplay=true width=1920 height=1080 %}
    </div>
</div>
<div class="caption">
